...
const previousOperandTxt = document.querySelector("[data-prev-operand]");
const currentOperandTxt = document.querySelector("[data-curr-operand]");
...
equalsButton.addEventListener("click", (buttion) => {
  calculator.compute();
  calculator.updateDisplay();
});

allClearButton.addEventListener("click", (buttion) => {
  calculator.clear();
  calculator.updateDisplay();
});

deleteButton.addEventListener("click", (buttion) => {
  calculator.delete();
  calculator.updateDisplay();
});
